...
const DEFAULT_CONFIG = { minimoViandas: 0, envioGratisActivo: false, envioGratisDesde: 0, descuentosCantidad: [] };
    ...
    const unsubscribe = onSnapshot(
      ...
      (snapshot) => {
        ...
        setConfig({
          ...
          descuentosCantidad: Array.isArray(data.descuentosCantidad) ? data.descuentosCantidad : [],
        });
      },
